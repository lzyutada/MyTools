...
namespace C_WMS.Data.CWms.Interfaces.Methods
{
    ...
    /// 批量从商城向WMS同步入库订单
    /// </summary>
    class CWmsOrdersSync_EntryOrder : CWmsEntryOrderCreate
    {
...
#else
            retObj = new HttpRespXml_EntryOrderCreate(@"<?xml version='1.0' encoding='UTF-8' standalone='yes'?><response><flag>failure</flag><code>400</code><message>仓库未配置</message><entryOrderId>1291</entryOrderId></response>");
#endif
            return retObj;
        }
...
#region Members -and- Properties
        ...
        public int DoGetVEntryOrders()
        {
            ...
            List<CWmsEntity.CWmsEntryOrder> tmpList = null;
            ...
            err = CWmsDataFactory.GetVEntryOrders(filters, out tmpList, out errMsg);
