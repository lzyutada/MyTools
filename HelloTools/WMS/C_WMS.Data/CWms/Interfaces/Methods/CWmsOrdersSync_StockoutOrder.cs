...
namespace C_WMS.Data.CWms.Interfaces.Methods
{
    ...
    /// 批量从商城向WMS同步出库订单
    /// </summary>
    class CWmsOrdersSync_StockoutOrder : CWmsStockoutCreate
    {
...
#else
            retObj = new HttpRespXml_StockoutOrderCreate(@"<?xml version='1.0' encoding='UTF-8' standalone='yes'?><response><flag>failure</flag><code>400</code><message>仓库未配置</message><deliveryOrderId>1291</deliveryOrderId></response>");
#endif
            return retObj;
        }
...
#region Members -and- Properties
        ...
        /// 待同步的主出库单列表
        /// </summary>
        List<CWmsEntity.CWmsExWarehouseOrder> OrderList { get { return _orderList; } }
        List<CWmsEntity.CWmsExWarehouseOrder> _orderList = new List<CWmsEntity.CWmsExWarehouseOrder>(1);

        /// <summary>
        /// 获取当前待处理的主出库订单
        /// </summary>
        public CWmsEntity.CWmsExWarehouseOrder CurrentOrder { get { return _currentOrder; } }
        public CWmsEntity.CWmsExWarehouseOrder _currentOrder = null;

        /// <summary>
        /// 获取当前待处理的主出库订单的子出库单列表
        /// </summary>
        List<CWmsEntity.CWmsExWarehouseSubOrder> SubOrderList { get { return _subOrderList; } }
        List<CWmsEntity.CWmsExWarehouseSubOrder> _subOrderList = new List<CWmsEntity.CWmsExWarehouseSubOrder>(1);

        /// <summary>
        /// 获取当前待处理的主出库订单的子出库单列表
        /// </summary>
        public CWmsEntity.CWmsExWarehouseSubOrder CurrentSubOrder { get { return _currentSubOrder; } }
        CWmsEntity.CWmsExWarehouseSubOrder _currentSubOrder = null;
#endregion
        ...
        public void ReloadSubOrders()
        {
            ...
            if (null != CurrentOrder)
            {
                ...
                {
                    CWms.CWmsEntity.CWmsExWarehouseSubOrder seo = new CWmsEntity.CWmsExWarehouseSubOrder(so as CWmsEntity.CWmsExWarehouseSubOrder);
        ...
        public int DoGetVStockoutOrders()
        {
            ...
            List<CWmsEntity.CWmsExWarehouseOrder> tmpList = null;
