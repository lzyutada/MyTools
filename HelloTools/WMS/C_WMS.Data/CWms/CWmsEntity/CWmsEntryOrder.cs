...
namespace C_WMS.Data.CWms.CWmsEntity
{
    ...
    class CWmsEntryOrderHandler : CWmsOrderBaseHandlerBase<CWmsEntryOrder, MangoEntryOrder, WmsEntryOrder, CWmsSubEntryOder, CWmsEntryOrderHandler>
    {
        ...
        {
            return Dict709Handle.UpdateRow_Order( TDict709_Value.EEntryOrder, pEid, pEsId, pUpdateOk, pDel, out pMsg);
        }
        ...
        {
            return Dict709Handle.UpdateRowA_Order(TDict709_Value.EEntryOrder, pEid, pEsId, pUpdateOk, pDel, out pMsg);
        }
