...
namespace C_WMS.Data.Wms.Data
{
    ...
    /// </summary>
    [XmlRoot("request")]
    class HttpReqXml_ReturnOrderCreate : HttpReqXmlBase
    {
        /// <summary>
        /// node 'returnOrder'
        /// </summary>
        ...
        /// default constructor
        /// </summary>
        public HttpReqXml_ReturnOrderCreate(CWmsReturnOrder pOrder)
        {
    ...
    /// </summary>
    [XmlRoot("orderLine")]
    class HttpReqXml_ReturnOrderCreate_Orders
    {
        #region Properties
        /// <summary>
        /// 入库单的行号
        ...
        /// <param name="srcObj">源对象实体</param>
        /// <returns>若拷贝成功则返回string.Empty; 否则返回错误描述</returns>
        public string CopyFrom(CWmsSubReturnOrder srcObj)
        {
            throw new NotImplementedException();
#if C_WMS_V1
            if (null == srcObj)
            ...
            ownerCode = srcObj.WmsOrder.Owner.WmsID; ; // TODO: 获取货主
